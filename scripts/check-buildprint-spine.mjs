...
for (const slug of slugs) {
  ...
  if (slug === 'buildprint-mapper-os') {
    const mapperRequired = [
      ...
      ['selected extraction prompt executable blueprint v5', fs.readFileSync(path.join(dir, 'prompts/extract-selected.md'), 'utf8'), /executable-blueprint\.v5|03-phases/i],
      ...
      ['executable blueprint schema template', fs.readFileSync(path.join(dir, 'templates/executable-packet/blueprint.yaml'), 'utf8'), /schema_version:\s*mapper-os\/executable-blueprint\.v5/i],
