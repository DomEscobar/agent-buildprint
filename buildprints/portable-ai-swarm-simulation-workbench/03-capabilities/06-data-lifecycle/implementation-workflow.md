...
Implement the smallest vertical slice that exercises real inputs, state transitions, error handling, persistence/readback, and visible UI or runtime behavior for `06-data-lifecycle`.
