...
- [game-asset-generation](https://github.com/DomEscobar/isometric-framework/blob/7542ff68de04ca6ea6736974b54ec5b5dde1cc33/skills/game-asset-generation/SKILL.md): Only new raster generation/removal: approved technique, provider capability, alpha, exact requests and local provenance. The chosen project technique determines whether any provider example applies.
