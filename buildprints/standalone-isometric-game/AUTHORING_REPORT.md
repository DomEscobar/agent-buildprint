...
## 0.1.0 package note
The historical records remain evidence about their named sessions. Version `0.1.0` packages the compatible CLI and this packet for npm distribution; it does not retroactively change hosted manifests, existing snapshots or historical source availability. Current installation and operational limits are documented in `README.md` and `references/cli-integration.md`.
