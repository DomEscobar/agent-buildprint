...
Audit the host's current components for hardcoded values. Replace with tokens. This is the most labor-intensive step in this loop.
...
- Banned defaults audit no longer flags the host for any color, type, space, radius, elevation, or motion violations introduced by this loop.
