...
Install the bounded `design-quality-lift` capability into a compatible host so the declared verify checks pass or blockers are honest.
...
## Hard-stop questions
 ...
 (must resolve before source edits)
