# Loop 10 — Story Maps, Gyms, Major Dungeons
...
Expand map content and implement **every quest** in the story graph. This loop is not complete until validation passes at **100%** for the target claim.
