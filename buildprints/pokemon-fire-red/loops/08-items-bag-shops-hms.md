...
### Save system (required this loop — not deferred to phase 13)
...
Loop 13 expands save UI (export/import, slot selection polish) — core persistence **must work here**.
