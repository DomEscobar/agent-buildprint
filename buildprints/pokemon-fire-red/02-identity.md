...
This file runs after `01-setup.md` and before `loops/*`.

Load `.agents/skills/frontend-ui-product-design/SKILL.md` and its `references/screen-states.md` if present. If the skill harness is missing, return to `01-setup.md` and record the blocker.
