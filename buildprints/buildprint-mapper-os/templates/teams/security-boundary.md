...
- Secret-name-only contracts; no secret values in generated output or review artifacts.
...
- Sensitive capability promotion without security verification or blocker.
