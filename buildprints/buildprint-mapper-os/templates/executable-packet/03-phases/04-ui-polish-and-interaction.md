...
- Run or record selected typed proof paths from `docs/architecture.md`, especially viewport, stress, semantic-output, or operator/integration proof when applicable.
