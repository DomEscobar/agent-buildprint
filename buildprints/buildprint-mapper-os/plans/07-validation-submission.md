...
- Run selected-output shape validation for generated selected/full-suite executable-blueprint packets and v5 regression fixtures.
...
- Selected output shape is valid: executable-blueprint v5 spine, proof-gated phase packets, evidence-ledger routing, no legacy v1-v4 spine files, no packet AGENTS.md, no fragmented per-capability mini-files, no typo aliases, and no duplicate canonical handoff files.
