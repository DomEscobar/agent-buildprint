...
- Review the packet for product-led alignment: central artifact, first usable loop, honest boundaries, forbidden shortcuts, usable phase slices, skeptical review, and concise handover.
...
- Selected output shape is valid: executable Buildprint spine, phase-flow, product-led phase packets, review, handover, no obsolete router/spine files, no packet AGENTS.md, no fragmented per-capability mini-files, no typo aliases, and no duplicate canonical handoff files.
