...
- Run selected-output shape validation for generated selected/full-suite packages and MicroFish regression fixtures.
...
- Selected output shape is valid: router-first spine, complete capability packs, manifest parity, no typo aliases, and no duplicate canonical handoff files.
