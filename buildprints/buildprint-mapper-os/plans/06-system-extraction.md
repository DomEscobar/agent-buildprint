...
- Validate package shape before handoff: no missing phase proof gates, no legacy v1-v4 spine files, no packet AGENTS.md, no fragmented per-capability mini-files, no typo aliases, and no duplicate canonical handoff files.
