...
2. Keep executable Buildprint templates aligned to the required package shape.
...
- Legacy selected-output legacy files are no longer generated. Their useful concepts now live in executable Buildprint files: `01-questions.md`, `02-project-setup.md`, `03-phases/phase-index.yaml`, phase Markdown files, `04-evaluation.md`, and `05-evidence/evidence-ledger.jsonl`.
