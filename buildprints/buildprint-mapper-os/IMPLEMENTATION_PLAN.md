...
- The Mapper OS package must teach source discovery, capability-packet extraction, selected-buildprint packaging, downstream execution planning, and qualification.

## Maintenance Milestones

1. Keep `mapper-os-requirement.md` and this package aligned.
2. Keep capability-packet v4 templates aligned to the required package shape.
...
- Legacy selected-output v1/v2 files are no longer generated. Their useful concepts now live in capability-packet v4 files: `03-capabilities/capability-index.yaml`, capability Markdown files, `07-execution/implementation-plan.yaml`, `08-evaluation/`, and `.buildprint/evidence/evidence-ledger.jsonl`.
- `BUILDPRINT.md` is package overview; `START_HERE.md` and `blueprint.yaml` are execution authority for generated selected packets.
