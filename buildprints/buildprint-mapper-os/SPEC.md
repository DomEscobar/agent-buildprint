...
- `02-project-setup.md` creates the architect foundation: stack, project-local skill harness, local `AGENTS.md`, `docs/architecture.md`, `docs/ui-identity.md`, env contract, setup receipt, and any required local UI/operator identity decisions.
