...
This packet uses blueprint_mode `integration` with phase_style `boundary_transaction_contract`. Do not apply UI/browser proof requirements to non-UI modes unless the phase explicitly declares ux-ui-craft as a required role.
