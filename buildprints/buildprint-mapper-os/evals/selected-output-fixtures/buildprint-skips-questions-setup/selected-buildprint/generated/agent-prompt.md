...
Start from `BUILDPRINT.md`, then follow `01-questions.md`, `02-project-setup.md`, `03-phases/phase-index.yaml`, `03-phases/phase-flow.md`, the active phase file, `04-evaluation.md`, and `05-evidence/evidence-ledger.jsonl`.
