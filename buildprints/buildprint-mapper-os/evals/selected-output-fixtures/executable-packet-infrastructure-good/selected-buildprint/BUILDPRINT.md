# BUILDPRINT: fixtures/executable-packet-infrastructure-good
...
- Product: fixtures/executable-packet-infrastructure-good
- Primary outcome: prove the service deployment operations: deploy/apply, health/readiness, rollback, drift detection, observability, and environment proof
- Primary users: developers, operators, or consumers of this capability
- Main surfaces: IaC manifests, deployment operator, health/readiness endpoint, observability hooks, rollback mechanism
- What this packet must not become: infrastructure written as UI or API work when the meaningful operation is deployment and health
