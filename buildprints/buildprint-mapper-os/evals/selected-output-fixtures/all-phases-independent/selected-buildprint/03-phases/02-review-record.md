# Phase 02 — Upload and persist submitted records
...
- Proof id: proof-02-review-record
...
Required runtime evidence row must use `phase_id: 02-review-record` and write to `.buildprint/evidence/evidence-ledger.jsonl`.
