...
This packet uses blueprint_mode `data-pipeline` with phase_style `dataflow_contract`. Do not apply UI/browser proof requirements to non-UI modes unless the phase explicitly declares ux-ui-craft as a required role.
