...
| security-boundary | upload and provider-facing user data | path containment, secret handling, and abuse/error boundaries | capability proof ledger | selected |
...
3. `integration-runtime`, `security-boundary`, and `data-persistence` validate provider/runtime, security, and persistence blockers.
