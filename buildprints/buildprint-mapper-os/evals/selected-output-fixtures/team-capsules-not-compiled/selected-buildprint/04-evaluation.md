...
- visual_quality_gate: UI-bearing phases look and behave like product-grade domain surfaces. Functional browser assertions are insufficient when screenshots show default browser controls, generic cards, stacked forms, raw text-list substitutes, weak hierarchy, missing focus/disabled states, or mobile/desktop overlap.
