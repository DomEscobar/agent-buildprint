...
This packet uses blueprint_mode `infrastructure` with phase_style `operations_contract`. Do not apply UI/browser proof requirements to non-UI modes unless the phase explicitly declares ux-ui-craft as a required role.
