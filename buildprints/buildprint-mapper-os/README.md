...
- Shape the downstream agent with posture-aware role/rule (`trusted_local`, `private_authenticated`, `public_webapp`): artifact type, real consumer, central artifact/interface/boundary, first usable loop, v4 product-system spine where relevant, honest boundaries, forbidden shortcuts, skeptical review, concise handover.
