# Capability 04 — Project Workspace Auth
...
A user can complete the Project Workspace Auth workflow with visible empty, loading/progress, success/ready, error, blocked, and retry states where applicable.
...
5. Append proof or blocker rows to `.buildprint/evidence/evidence-ledger.jsonl` using `capability_id: project-workspace-auth`.
