# Capability 06 — Script Agent Assets
...
A user can complete the Script Agent Assets workflow with visible empty, loading/progress, success/ready, error, blocked, and retry states where applicable.
