...
- Primary outcome: Execution-packet remap of the Toonflow-inspired portable creative pipeline: project workspace, ordered novel ingestion, event extraction, scripts/assets, storyboard flow, media tasks, preview export, and safety gates.
- Primary users: operators or developers implementing the mapped product workflow.
- Main surfaces: BUILDPRINT.md execution entry; BUILDPRINT.md executable start file; blueprint.yaml authority packet; 00-intent mission, obligations, and source-surface map
