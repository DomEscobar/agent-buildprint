...
5. Append proof or blocker rows to `.buildprint/evidence/evidence-ledger.jsonl` using `phase_id: novel-event-ingestion`.
...
Required evidence row must use `phase_id: novel-event-ingestion` and write to `05-evidence/evidence-ledger.jsonl`.
