...
Selected blueprint mode: `product`. Phase style: `outcome_flow`. Implement a source-independent Novel Storyboard; do not preserve legacy branding or require original source access.
