...
This file is not source of truth and not authoritative. The canonical execution authority is `BUILDPRINT.md`; `blueprint.yaml` is the machine-readable mirror.
