# BUILDPRINT: Portable AI Presentation Generation OS
...
The phase-flow required artifacts under `.buildprint/phase-runs/<phase-id>/` must exist before runtime evidence is appended.
