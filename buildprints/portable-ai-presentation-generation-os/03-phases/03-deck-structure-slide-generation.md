...
5. Append proof or blocker rows to runtime artifact `.buildprint/evidence/evidence-ledger.jsonl` using `phase_id: deck-structure-slide-generation`.
...
- Proof id: proof-deck-structure-slide-generation
...
Required runtime evidence row must use `phase_id: deck-structure-slide-generation` and write to runtime artifact `.buildprint/evidence/evidence-ledger.jsonl`, not the packaged seed ledger.
