...
- Proof id: proof-02-content-ingestion-outline-generation
...
Required runtime evidence row must use `phase_id: 02-content-ingestion-outline-generation` and write to `.buildprint/evidence/evidence-ledger.jsonl`, not the packaged seed ledger.
