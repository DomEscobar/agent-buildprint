...
Before implementation phase work, the packet requires a Foundation scaffold gate: the target implementation project must create a real base project structure plus `AGENTS.md`, `architecture.md`, `engineering-standards.md`, `proof-strategy.md`, and `ui-identity.md` so coding agents have explicit architecture and clean-code guidance before editing code.
