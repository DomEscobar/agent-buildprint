...
- Foundation scaffold must create implementation-project `AGENTS.md`, `architecture.md`, `engineering-standards.md`, `proof-strategy.md`, and `ui-identity.md` before Phase 01 code.
