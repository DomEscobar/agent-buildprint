# Loop 06 - Claim Verification

This loop is the anti-overclaim gate for Agentic Chat. It does not add new product scope; it proves or lowers the claims from phases 04 and 05. If this loop is skipped, missing, or prose-only, the highest honest claim is at most `streaming_chat_core`.
...
- If the UI, README, metadata, or handover claims a higher level than `highest_honest_claim`, this loop fails until the product claim is lowered or the missing proof is captured.
