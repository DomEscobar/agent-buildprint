...
- Setup/standards verdict: before phase proof, verify the Foundation scaffold exists, `engineering-standards.md` is present, and its `Test standards` require deterministic timeouts, blocked-proof behavior, and non-hanging exits.
