...
- Phase style: `outcome_flow`.
- Public product name: Agentic Chat. Do not use legacy public branding terms in title, slug, UI copy, or package identity unless describing a technical runtime boundary inside implementation notes.
