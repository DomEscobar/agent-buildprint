...
This packet is deliberately narrow and deep, and **stack-neutral**. Provider/model, framework, transport, and persistence are chosen by the user in `00-questions.md`, not pre-committed. The 1.0 core is:
...
Deferred to `EXTENSIONS.md` and out of 1.0 scope: tools/skills, MCP policy, memory/compaction, and subagents. Their seams are designed but not built or faked.
