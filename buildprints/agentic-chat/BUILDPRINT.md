...
1. `BUILDPRINT.md`
2. `references/runtime-techniques-basis.md`
3. `00-questions.md`
4. `01-project-setup.md`
5. `02-ui-identity.md` when the artifact has UI or human-facing interaction
6. `blueprint.yaml`
...
11. `03-phases/06-claim-verification.md` before any `agentic_chat` or `agentic_swarm` completion claim
12. `HANDOVER.md` before stopping or claiming completion
