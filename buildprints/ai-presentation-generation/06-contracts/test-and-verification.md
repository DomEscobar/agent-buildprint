...
- `## Setup/standards verdict`: confirm implementation-project `engineering-standards.md` exists and its Test standards define deterministic blocker, e2e, and runtime exit behavior.
