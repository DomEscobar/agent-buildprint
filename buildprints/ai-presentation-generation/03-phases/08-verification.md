...
Prove the user-visible flow and integration seams through real commands, browser/API walkthroughs, and honest blockers.
...
Run build/tests, browser walkthrough, provider/export blocked/live modes, API smoke, persistence reload, and final defect sweep.
...
No fake generation, fake export, dead control, or hidden provider failure remains.
