# Phase 99 - Final review handover

requires_roles: [product-architect, ux-ui-craft, integration-runtime, data-persistence, security-boundary]

## Product intention

Act as the final skeptical reviewer and package a concise implementation handover.
...
Run `04-review.md`, fix or record defects, then complete `05-handover.md` with proof, blockers, and next actions.
...
The next agent can trust exactly what is built, what is blocked, and what remains.
