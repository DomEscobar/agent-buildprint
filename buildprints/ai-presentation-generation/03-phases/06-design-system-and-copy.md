...
Raise the product to a polished deck editor: strong canvas hierarchy, thumbnails, outline, command areas, export states, and plain-language blockers.
...
Implement visual system, interaction states, copy, loading/progress, accessibility, and responsive polish.
...
It feels like a presentation workbench, not a generic admin UI.
