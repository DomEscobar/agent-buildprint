...
Create the first usable workbench shell: provider readiness, create-deck entry, deck list, slide workspace, outline/assets/chat/export navigation, and blocked-state surfaces.
...
Build the app shell, route structure, responsive layout, status banners, and empty states that lead to the deck loop.
...
The shell makes the next action obvious and has no dead navigation.
