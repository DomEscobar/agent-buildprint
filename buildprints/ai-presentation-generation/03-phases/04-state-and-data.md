...
Make deck, asset, template, generation, chat, export, and task state durable and inspectable after reload/restart.
...
Implement storage, migrations or schema, readback tests, task state, file handling, and privacy/retention boundaries.
...
Reload/restart does not erase visible deck history or task status.
