...
Connect provider-neutral intelligence to outline, slide generation, image prompts, template mapping, chat iteration, and local-model blockers.
...
Implement provider/image adapters, prompt contracts, generation traces, cost/error states, and selected-slide/deck-scoped chat behavior.
...
AI output is input-sensitive, provider-aware, and never silently mocked.
