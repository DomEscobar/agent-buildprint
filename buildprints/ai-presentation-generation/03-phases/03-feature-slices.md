...
Add core Presenton-like deck features without breaking the first loop: editable outline, slide content edits, layout/theme selection, image/icon/chart placeholders backed by state, and progress feedback.
...
Implement one coherent vertical slice at a time with persisted changes and visible UI feedback.
...
Every added control changes deck state or reports why it is blocked.
