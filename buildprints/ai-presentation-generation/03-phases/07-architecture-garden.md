...
Keep integrations clean as the product grows: API tasks, webhooks, MCP server, desktop wrapper, export workers, and provider adapters stay separated and testable.
...
Refactor seams, add contract tests, document extension points, and prevent UI/provider/export coupling.
...
Future API/MCP/desktop/export work can proceed without rewriting the deck loop.
