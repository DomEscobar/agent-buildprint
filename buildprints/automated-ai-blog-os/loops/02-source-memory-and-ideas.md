# Loop 02 - Source Memory And Ideas
...
Implement source scanning, retrieval status, content memory, used-angle tracking, banned claim checks, internal link inventory, and idea scoring. The product path should turn captured sources into IdeaRecords with explicit rubric fields and show why each idea is useful, weak, repeated, blocked, or ready for drafting.
