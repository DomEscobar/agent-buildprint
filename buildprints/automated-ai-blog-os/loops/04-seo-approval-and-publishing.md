# Loop 04 - SEO Approval And Publishing
...
Implement SEO validation, feed/sitemap/llms/build checks, approval queue, and publisher/scheduler seam. Publishing must fail closed unless claim validation, metadata/schema/feed/build checks, and human approval have passed. Any schedule or publish side effect must be explicit, auditable, and blocked without provider proof.
