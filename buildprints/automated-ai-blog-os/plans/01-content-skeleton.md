...
2. Create durable folders for `content-research`, `content-memory`, posts, visuals/components, `storage/{sources,drafts,approvals,seo-reports,publish-reports}`, and tests/fixtures.
