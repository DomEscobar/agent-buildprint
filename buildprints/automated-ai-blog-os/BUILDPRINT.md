...
Build Automated AI Blog OS. Create a Markdown/MDX-first editorial automation pipeline with source scanning, idea scoring, content memory, draft generation, visual post templates, claim validation, SEO/feed/build validation, approval gates, publisher/scheduler seams, and manager audit. It is not a generic CMS or blog theme.
