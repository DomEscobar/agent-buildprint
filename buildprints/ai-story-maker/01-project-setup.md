...
- `docs/ui-identity.md` or `UI-IDENTITY.md` - visual identity, interaction model, motion, accessibility, empty/loading/error/blocked states, story drafting stress fixtures, and anti-generic shell rules.
