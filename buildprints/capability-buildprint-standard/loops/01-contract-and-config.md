...
Implement contract and config seams for the bounded `capability-buildprint-standard` capability without redesigning the host. Keep changes scoped to capability.yaml touches. Leave honest blockers when host signals are missing.
