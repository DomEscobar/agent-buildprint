...
Implement operator/user surface and verification readiness for the bounded `capability-buildprint-standard` capability without redesigning the host. Keep changes scoped to capability.yaml touches. Leave honest blockers when host signals are missing.
