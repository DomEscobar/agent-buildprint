...
Capability questions are assessment-led. Do not ask broad intake questions before inspecting the host project. Use host evidence to reduce noise, then ask only what blocks a safe integration.
...
- tenant, team, project, customer, or document boundaries
...
- first live surface to protect, bill, retrieve from, publish to, or otherwise alter
