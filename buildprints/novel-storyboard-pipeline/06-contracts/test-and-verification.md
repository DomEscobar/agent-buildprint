...
- Setup/standards verdict: before Phase 01 proof, verify `engineering-standards.md` exists, root `AGENTS.md` names it as a mandatory read, and its Test standards define deterministic timeout/exit behavior for blocked e2e/runtime proof.
