...
Build AI Influencer OS. Create an OpenClaw-based fictional influencer runtime with persona canon, private relationship memory, separate persona life state, Wavespeed image generation, grounded social drafting, manual publishing handoff, secured local browser/noVNC workflow, and manager audit. It is not a generic chatbot, scheduler, or SaaS dashboard.
