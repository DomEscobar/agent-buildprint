...
4. Create or update `docs/architecture.md` with stack, topology, persistence, provider seams, deployment posture, central output contract, proof commands, blockers, and claim ceilings. Name main modules and seams; deepen only as loops demand — do not build architecture garden theater before the first loop.
...
- Production maturity (budgets, swarm ledgers, trust zones) is not a setup floor.
